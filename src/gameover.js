...
export const initGameover = (startNewGame, gameoverToMenu) => {
  gameoverWrapper.style.cssText = 'position:absolute;inset:0;padding:10vmin;pointer-events:none;opacity:0';
  ...
  scoreWrapper.style.cssText = `display:inline-flex;padding:6px 10px;line-height:24px;color:#fff;border-radius:24px;opacity:0;background:${colors.ui}`;
...
export const showGameover = () => {
  ...
  scoreWrapper.style.transition = 'opacity 1s 4s';

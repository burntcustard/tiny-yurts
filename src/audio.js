...
const warnNotes = {
  ...
  [colors.goat]: {
    ...
    notes: [
      ...
      [18, 2, 2, 0, 0.4, 10000, 1000], // F#
      [14, 2, 2, 0, 0.4, 10000, 1000], // D
      [13, 2, 2, 0, 0.4, 10000, 1000], // C#
      [14, 2, 2, 1, 0.4, 10000, 1000], // D

      [9, 2, 2, 0, 0.4, 10000, 1000], // A
      [18, 2, 2, 0, 0.4, 10000, 1000], // F#
      [13, 2, 2, 0, 0.4, 10000, 1000], // C#
      ...
      [8, 2, 2, 0, 0.4, 10000, 1000], // G# (first one)
      [9, 2, 2, 0, 0.4, 10000, 1000], // A
      [6, 2, 2, 0, 0.4, 10000, 1000], // F# (lower...down I don't know music)
      [8, 2, 2, 0, 0.4, 10000, 1000], // G#
    ],
  },
  [colors.fish]: {
    currentIndex: 0,

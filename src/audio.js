...
const warnNotes = {
  [colors.ox]: {
    currentIndex: 0,
    notes: [
      // [18, 0.5, 0.5, 30, 0.3, 1800, 200], // F#
      // [15, 0.5, 0.5, 30, 0.3, 1800, 200], // D#
      // [13, 0.5, 0.5, 30, 0.3, 1800, 200], // C#
      // [15, 0.5, 0.5, 30, 0.3, 1800, 200], // D#

      // [10, 0.5, 0.5, 30, 0.3, 1800, 200], // A#
      // [18, 0.5, 0.5, 30, 0.3, 1800, 200], // F#
      // [13, 0.5, 0.5, 30, 0.3, 1800, 200], // C#
      ...
      // [ 8, 0.5, 0.5, 30, 0.3, 1800, 200], // G# (first one)
      // [10, 0.5, 0.5, 30, 0.3, 1800, 200], // A#
      [ 5, 0.5, 0.5, 30, 0.3, 1800, 200], // E# (F)
      // [ 8, 0.5, 0.5, 30, 0.3, 1800, 200], // G#

      // [8, 0.2, 0.25, 300, 0.6, 230, 50],
      // [9, 0.2, 0.25, 300, 0.6, 230, 50],
      // [0, 0.2, 0.2, 300, 0.6, 220, 50],
  ...
  [colors.goat]: {
    ...
    notes: [
      ...
      [27, 1, 0.995, 1, 0.3, 3000, 1000], // D#

      [22, 1, 1, 1, 0.3, 3000, 1000], // A#
      [30, 1, 1, 1, 0.3, 3000, 1000], // F#
      [25, 1, 1, 1, 0.3, 3000, 1000], // C#
      ...
      [22, 1, 1, 1, 0.3, 3000, 1000], // A#
      [17, 1, 1, 1, 0.3, 3000, 1000], // E# (i.e. F. Music is weird)
